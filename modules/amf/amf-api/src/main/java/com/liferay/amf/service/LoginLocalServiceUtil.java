 ...
 * <code>com.liferay.amf.service.impl.LoginLocalServiceImpl</code> and
...
public class LoginLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.amf.service.impl.LoginLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Login addLogin(Login login) {
	...
	public static Login createLogin(long loginId) {
		return getService().createLogin(loginId);
	}
	 ...
	 */
	public static Login deleteLogin(Login login) {
	 ...
	 */
	public static Login deleteLogin(long loginId) throws PortalException {
		return getService().deleteLogin(loginId);
	}
	...
	public static Login fetchLogin(long loginId) {
		return getService().fetchLogin(loginId);
	}
	 ...
	 * @throws PortalException if a login with the primary key could not be found
	 */
	public static Login getLogin(long loginId) throws PortalException {
		return getService().getLogin(loginId);
	}
	 ...
	 */
	public static List<Login> getLogins(int start, int end) {
	 ...
	 */
	public static Login updateLogin(Login login) {
	...
	private static volatile LoginLocalService _service;
