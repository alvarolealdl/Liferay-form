...
public interface RegistrationLocalService
	...
	public Registration createRegistration(long amfRegistrationId);
	...
	public Registration deleteRegistration(long amfRegistrationId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Registration fetchRegistration(long amfRegistrationId);
