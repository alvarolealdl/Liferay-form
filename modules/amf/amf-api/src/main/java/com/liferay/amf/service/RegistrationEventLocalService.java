...
/**
 * Provides the local service interface for RegistrationEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Bruno Queiroz
 * @see RegistrationEventLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RegistrationEventLocalService
	...
	public RegistrationEvent addRegistrationEvent(
	...
	public RegistrationEvent createRegistrationEvent(long registrationEventId);
	...
	public RegistrationEvent deleteRegistrationEvent(long registrationEventId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RegistrationEvent deleteRegistrationEvent(
		RegistrationEvent registrationEvent);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RegistrationEvent fetchRegistrationEvent(long registrationEventId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RegistrationEvent getRegistrationEvent(long registrationEventId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RegistrationEvent> getRegistrationEvents(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RegistrationEvent updateRegistrationEvent(
		RegistrationEvent registrationEvent);
